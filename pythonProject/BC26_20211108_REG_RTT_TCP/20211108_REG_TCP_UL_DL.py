...
UL_datetime_list = read_datetimes("BC26_20211108_REG_RTT_TCP_datas/UL_Datetime.txt")
UL_delay_list = read_delay("BC26_20211108_REG_RTT_TCP_datas/UL_Delay.txt")
...
rtt_splited_by_50_client = split_rtt_by_interval(UL_delay_list, UL_datetime_list, datetime_change)
# print("测试次数")
...
DL_datetime_list = read_datetimes("BC26_20211108_REG_RTT_TCP_datas/DL_Datetime.txt")
DL_delay_list = read_delay("BC26_20211108_REG_RTT_TCP_datas/DL_Delay.txt")
...
# # 根据时间间隔对所有数据进行分割，用于数据分析而非可视化！
rtt_splited_by_50_server = split_rtt_by_interval(DL_delay_list, DL_datetime_list, datetime_change)
print("DL 均值")
...
axes[0].set_title("20211108 20:00-10:00 LwM2M/CoAP/TCP/NB-IoT BC26 REG UL_DL_delay", fontsize=20)
plt.show()
