...
def read_delay(delay_file):
    ...
    return delay_list
## import data
firmware_5700_UL_datetime_file = '../app_bc26_20210221-20210222_datas/app_bc26_20210221-20210222_5700/app_bc26_20210221-20210222_5700_UL_datetime.txt'
firmware_5700_UL_delay_file = '../app_bc26_20210221-20210222_datas/app_bc26_20210221-20210222_5700/app_bc26_20210221-20210222_5700_UL_delay.txt'
...
firmware_5700_DL_datetime_file = '../app_bc26_20210221-20210222_datas/app_bc26_20210221-20210222_5700/app_bc26_20210221-20210222_5700_DL_datetime.txt'
firmware_5700_DL_delay_file = '../app_bc26_20210221-20210222_datas/app_bc26_20210221-20210222_5700/app_bc26_20210221-20210222_5700_DL_delay.txt'
...
size_of_legend = 10
##create plot
ax.set_title("Application-D UL/DL delay",size=20)
...
ax.plot(df0["datetime"], df0["values"], label="firmware_5700_DL", color='g', alpha=0.4)

ax.hlines(y = 1757, xmin=firmware_5700_UL_datetime[0], xmax=firmware_5700_UL_datetime[len(firmware_5700_UL_datetime) - 1], color='y', linestyles='--', alpha = 0.8)
ax.hlines(y = 996, xmin=firmware_5700_DL_datetime[0], xmax=firmware_5700_DL_datetime[len(firmware_5700_DL_datetime) - 1], color='g', linestyles='--', alpha = 0.8)
ax.legend(loc=1, prop={'size':size_of_legend})
ax.set_xlim(xmin=firmware_5700_UL_datetime[0], xmax=firmware_5700_UL_datetime[len(firmware_5700_UL_datetime) - 1])
ax.set_ylim(0, 9000)
