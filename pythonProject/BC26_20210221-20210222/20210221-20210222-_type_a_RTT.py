...
read1_datetime_file = '../app_bc26_20210221-20210222_datas/app_bc26_20210221-20210222_read1/app_bc26_20210221-20210222_read1_datetime.txt'
read1_RTT_file = '../app_bc26_20210221-20210222_datas/app_bc26_20210221-20210222_read1/app_bc26_20210221-20210222_read1_RTT.txt'
...
read5_RTT_file = '../app_bc26_20210221-20210222_datas/app_bc26_20210221-20210222_read5/app_bc26_20210221-20210222_read5_RTT.txt'
...
read3333_RTT_file = '../app_bc26_20210221-20210222_datas/app_bc26_20210221-20210222_read3333/app_bc26_20210221-20210222_read3333_RTT.txt'
...
read1_datetime = read_datetimes(read1_datetime_file)
read1_RTT = read_delay(read1_RTT_file)
#read5
...
read5_datetime = read_datetimes(read5_datetime_file)
read5_RTT = read_delay(read5_RTT_file)
#read3333
...
read3333_datetime = read_datetimes(read3333_datetime_file)
read3333_RTT = read_delay(read3333_RTT_file)
#read34828
...
read34828_datetime = read_datetimes(read34828_datetime_file)
read34828_RTT = read_delay(read34828_RTT_file)
...
##create plot
ax = axes[0]
ax.set_title("Application-A RTT",size=20)
...
# ax.plot(df0["datetime"], df0["values"], label="read1_UL", color='g', alpha=0.4)
df0 = pd.DataFrame({"values":read1_RTT, "datetime":read1_datetime})
ax.plot(df0["datetime"], df0["values"], label="read1_RTT", color='b', alpha=0.4)
...
ax.hlines(y = 5225, xmin=read1_datetime[0], xmax=read1_datetime[len(read1_datetime) - 1], color='b', linestyles='--', alpha = 0.4)
ax.legend(loc=1, prop={'size':size_of_legend})
ax.set_xlim(xmin=read1_datetime[0], xmax=read1_datetime[len(read1_datetime) - 1])
ax.set_ylim(0, 9000)
...
# ax.plot(df1["datetime"], df1["values"], label="read5_UL", color='g', alpha=0.4)
...
df0 = pd.DataFrame({"values":read5_RTT, "datetime":read5_datetime})
ax.plot(df0["datetime"], df0["values"], label="read5_RTT", color='b', alpha=0.4)
ax.hlines(y = 2708, xmin=read5_datetime[0], xmax=read5_datetime[len(read5_datetime) - 1], color='b', linestyles='--', alpha = 0.4)
ax.legend(loc=1, prop={'size':size_of_legend})
ax.set_xlim(xmin=read5_datetime[0], xmax=read5_datetime[len(read5_datetime) - 1])
ax.set_ylim(0, 9000)
...
# ax.plot(df2["datetime"], df2["values"], label="read3333_UL", color='g', alpha=0.4)
...
# ax.hlines(y = 782, xmin=read3333_DL_datetime[0], xmax=read3333_DL_datetime[len(read3333_DL_datetime) - 1], color='g', linestyles='--', alpha = 0.4)
df0 = pd.DataFrame({"values":read3333_RTT, "datetime":read3333_datetime})
ax.plot(df0["datetime"], df0["values"], label="read3333_RTT", color='b', alpha=0.4)
ax.hlines(y = 3538, xmin=read3333_datetime[0], xmax=read3333_datetime[len(read3333_datetime) - 1], color='b', linestyles='--', alpha = 0.4)
ax.legend(loc=1, prop={'size':size_of_legend})
ax.set_xlim(xmin=read3333_datetime[0], xmax=read3333_datetime[len(read3333_datetime) - 1])
ax.set_ylim(0, 9000)
...
# ax.plot(df3["datetime"], df3["values"], label="read34828_UL", color='g', alpha=0.4)
# ax.hlines(y = 2713, xmin=read34828_UL_datetime[0], xmax=read34828_UL_datetime[len(read34828_UL_datetime) - 1], color='y', linestyles='--', alpha = 0.4)
# ax.hlines(y = 782, xmin=read34828_DL_datetime[0], xmax=read34828_DL_datetime[len(read34828_DL_datetime) - 1], color='g', linestyles='--', alpha = 0.4)
df0 = pd.DataFrame({"values":read34828_RTT, "datetime":read34828_datetime})
ax.plot(df0["datetime"], df0["values"], label="read34828_RTT", color='b', alpha=0.4)
ax.hlines(y = 2207, xmin=read34828_datetime[0] , xmax=read34828_datetime[len(read34828_datetime) - 1], color='b', linestyles='--', alpha = 0.4)
ax.legend(loc=1, prop={'size':size_of_legend})
ax.set_xlim(xmin=read34828_datetime[0], xmax=read34828_datetime[len(read34828_datetime) - 1])
ax.set_ylim(0, 9000)
