...
datetime_list = read_datetimes("BC26_20211108_2_REG_RTT_TCP_datas/ClientRegDateTime.txt")
RTT_list = read_delay("BC26_20211108_2_REG_RTT_TCP_datas/ClientRegRTT.txt")
...
datetime_list = read_datetimes("BC26_20211108_2_REG_RTT_TCP_datas/ServerRegDateTime.txt")
RTT_list = read_delay("BC26_20211108_2_REG_RTT_TCP_datas/ServerRegRTT.txt")
RTT_lists = split_array_into(RTT_list, n)
datetime_lists = split_array_into(datetime_list, n)
Server_packet_loss = read_datetimes("BC26_20211108_2_REG_RTT_TCP_datas/Server_packet_loss.txt")
