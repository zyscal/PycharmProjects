...
UL_datetime_list = read_datetimes("BC26_20211031_REG_RTT_TCP_datas/UL_Datetime.txt")
UL_delay_list = read_delay("BC26_20211031_REG_RTT_TCP_datas/UL_Delay.txt")
...
DL_datetime_list = read_datetimes("BC26_20211031_REG_RTT_TCP_datas/DL_Datetime.txt")
DL_delay_list = read_delay("BC26_20211031_REG_RTT_TCP_datas/DL_Delay.txt")
...
axes[0].set_title("20211031 21:30-12:30 LwM2M/CoAP/TCP/NB-IoT BC26 REG UL_DL_delay", fontsize=20)
plt.show()
